    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[hsl(var(--gradient-3-start))] to-[hsl(var(--gradient-3-end))] overflow-hidden">
      ...
      <div className="absolute left-[50%] top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative">
          ...
          <div className="absolute inset-0 animate-ripple-delayed-1 rounded-full border-2 border-white/25 opacity-0" />
          <div className="absolute inset-0 animate-ripple-delayed-2 rounded-full border-2 border-white/20 opacity-0" />
          <div className="absolute inset-0 animate-ripple-delayed-3 rounded-full border-2 border-white/15 opacity-0" />

          {/* Icon display */}
          <div className="w-28 h-28 md:w-36 md:h-36 bg-white/10 backdrop-blur-xl rounded-full border border-white/10 flex items-center justify-center relative z-10">
            {icons.map(({ Icon, label }, i) => (
              ...
              >
                <Icon
                  className="w-10 h-10 md:w-14 md:h-14 text-white/80"
                  strokeWidth={1.5}
                />
